...
- 已录入篇目：**59 条**，八辑均有已核/待核篇目；另收录 **10 部**书锚记（新增 C-yinchen《音尘集》）、5 种现有对照选本、3 类「不宜收」判例。
- 每篇带 `inclusion` 分级（必收 / 可选 / 资料库）。第二辑现 **16 篇**：《关于美国兵》完整 15 篇＋新增《印度小夜曲》（E-060，音尘集，必收）。
- 覆盖较好：第三辑（金陵，**24篇**，《金陵五记》全五个时间层基本录完）、第二辑（**16篇**）、第一辑（《锦帆集》蜀道/西南诸篇，**9篇**）、第八辑（人物，**5篇**）。
...
- **翔实附录（全部已整理资料并入论文成稿）**：附录一·本文征引篇目举要；附录二·与本项目其他文献的关系；**附录三·黄裳行旅篇目总表（全五十九篇，含原创摘要）**；附录四·收录书目（书锚）与版本；附录五·黄裳行旅年表；附录六·待核清单与已知缺口。其中附录三–六由 `data/huangshang_essays.json` 与 `notes/timeline_draft.md` **经构建脚本自动汇编**，与《编选方案》PDF 同源同步，确保已搜集资料完整保留、不致散失。
